...
from aoarashi.modules.mel_spectrogram import LogMelSpectrogram, MelSpectrogram


def test_mel_spectrogram():
    length = torch.tensor([16000, 8000])
    speech = torch.randn(2, 16000)
    module = MelSpectrogram(fft_size=512, hop_size=128, window_size=512, mel_size=80, sample_rate=16000)
